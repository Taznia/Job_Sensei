    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          ...
          requiredLevel: 85,
          priority: 'high',
          impact: 'Product managers align customers, business leaders, designers, and engineers around decisions.',
        },
        {
          name: 'User Research',
          ...
          requiredLevel: 70,
          priority: 'medium',
          impact: 'User research reveals the real problems a product should solve and validates proposed outcomes.',
        },
        {
          name: 'Prioritization',
          category: 'Product Strategy',
          requiredLevel: 65,
          priority: 'low',
          impact: 'Structured prioritization helps teams invest limited time in the highest-value outcomes.',
        },
      ],
    },
  ]);
